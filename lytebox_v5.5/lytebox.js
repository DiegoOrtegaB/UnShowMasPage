...
function Lytebox(bInitialize, aHttp) {
	/*** Language Configuration ***/
		...
		this.label['image'] 	= 'Paisaje %1 de %2';		// %1 = active image, %2 = total images
		this.label['page'] 		= 'Page %1 of %2'; 		// %1 = active page, %2 = total pages
		
	
	/*** Configure Lytebox ***/
	
		this.theme   			= (typeof lyteboxTheme !== 'undefined') && /^(black|grey|red|green|blue|gold|orange)$/i.test(lyteboxTheme) ? lyteboxTheme : 'red'; // themes: black (default), grey, red, green, blue, gold, orange
